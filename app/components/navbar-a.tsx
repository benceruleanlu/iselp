...
const NavBar = () => {
  return (
    <div className='flex flex-row justify-between min-w-screen p-4 border-b max-w-6xl mx-auto'>
        ...
        <div className='hidden md:flex flex-row items-center text-lg space-x-8 mr-4'>
