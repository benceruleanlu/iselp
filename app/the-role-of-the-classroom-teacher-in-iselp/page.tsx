...
const Page = () => {
  ...
  return (
    <>
      <NavBar />
      <div className='flex flex-row w-11/12 mx-auto my-6 lg:my-8 max-w-6xl lg:space-x-16 overflow-hidden text-wrap'>
            ...
            <p className="font-semibold text-xl" id='strategies-for-implementing-extensions-in-the-classroom'>Strategies for implementing extensions in the classroom</p>
              ...
              <>
                  ...
                  <table className="w-full text-sm text-left text-gray-700 min-w-[800px]">
                    ...
                    <tbody>
                      <tr className="bg-white border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Unchanged Task (Student Works to Complete Expected Product)</span></td>
                      ...
                      <tr className="bg-white border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Ambitious Undertaking (Goes Beyond Expectations)</span></td>  
                        <td className="py-4 px-6">
                      ...
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Ambitious Undertaking (Fails to Meet Expectations)</span></td>  
                        <td className="py-4 px-6">
                ...
                <p className="font-semibold text-xl" id='common-strategies-for-extensions-in-the-classroom'>Common strategies for extensions in the classroom</p>
                  ...
                  <table className="w-full text-sm text-left text-gray-700 min-w-[800px]">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-100">
                      <th scope="col" className="py-3 px-6 text-center">Strategy</th>
                      <th scope="col" className="py-3 px-6 text-center">Description</th>
                      <th scope="col" className="py-3 px-6 text-center">Implementation in the Classroom</th>
                    ...
                    <tbody>
                      <tr className="bg-white border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Developing Inquiry/Questioning Processes</span></td>
                          ...
                          <td className="py-4 px-6">
                            <p className = "text-center">Examples of Question Framing:</p>
                            <ol className = "list-disc pl-12">
                              <li>Yes, and then?</li>
                      ...
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Communicating Ideas</span></td>
                        <td>Many Gifted students require ongoing assistance in organizing their thoughts as they may have difficulty in communicating concepts or ideas that may seem intuitive to them; thereby their presentation of ideas seems disconnected; exhibiting leaps of reasoning to the audience at hand.</td>
                        <td>
                          <ol className = "list-disc pl-12">
                      ...
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Providing Choice and Open-Ended Learning</span></td>
                        <td>
                      ...
                      <tr className="bg-gray-50 border-b border-gray-200">
                        <td className="py-4 px-6"><span className='font-bold italic'>Helping Students Explore Areas of Strength</span></td>
                        <td>
                          ...
                          <br></br>
                          <p className = "text-center">Models of Learning:</p>
