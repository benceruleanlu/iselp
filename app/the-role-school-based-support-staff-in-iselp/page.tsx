              ...
              <>
                <p className='font-semibold text-xl' id='supporting-program extensions-and-differentiation-1'>Supporting program extensions and differentiation</p>
                  ...
                  <p className='font-semibold text-xl' id='withdrawal-supports-(as needed)'>Withdrawal supports (as needed)</p>
                    ...
                    <p>When a student is provided with opportunities for withdrawal as part of their ISELP programming, staff should ensure that the work completed as part of this withdrawal is focused and tailored toward the alternative goals and expectations, as outlined in the student&rsquo;s IEP.</p>
