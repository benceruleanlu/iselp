            ...
            <div className='space-y-4'>
              ...
              <hr />
                ...
                <ol className='list-disc pl-12'>
                  ...
                  <li>Coordinating with classroom teachers to ensure appropriate accommodations are working and are meeting the needs of the student</li>
                  <li>Being involved in development of transition plans and assisting students to execute plans</li>
                  <li>Supporting classroom teachers in developing, reviewing, and updating IEPs </li>
                  <li>Providing more information about Special Education programming to families/caregivers, as needed</li>
                  <li>Accessing additional supports and resources (e.g., SERT, PSSP, Itinerants, community-based, etc.), as needed</li>
                  <li>Coordinating supports and additional interventions to support student engaged in ISELP</li>
                </ol>

                <p>The primary role of the classroom teacher is to assist students engaged in ISELP to develop their intellectual and academic potential in collaboration with the student, parent/caregiver, and the ISSP teacher. This development is framed through the Gifted/Enhanced Learning Plan in the student’s IEP. Teaching a Gifted child comes with excitement and challenges. Educators must have the skills to differentiate their instruction to help students across the achievement spectrum grow to their full learning potential. The ISSP teacher can assist the classroom teacher to provide the appropriate accommodations and learning experiences that will support the student’s learning needs. The interplay between the student, classroom teacher and ISSP teacher is integral to offering the most effective learning environment for the learner who is part of ISELP.</p>
              ...
              <hr />
                ...
                <p className='font-semibold text-xl' id='supporting-program-extensions-and-differentiation'>Supporting program extensions and differentiation</p>
                  ...
                  <p>Providing learners engaged in ISELP with additional work and grading &lsquo;harder&rsquo; on an alternative set of expectations is punitive (e.g., extra-workload, stricter expectations in terms of grades) and it is likely that the student will build a reluctance to attempt such work.</p>
                  <p>Supporting classroom teachers with effective programming strategies can be one of the more delicate matters that an ISSP teacher will deal with in order to support a student who is engaged in ISELP. The ISSP teacher’s ultimate goal will be to act as an advocate for the learner’s needs while working with the student to develop their ability to self-advocate with classroom teachers.</p>
                  ...
                  <p className='font-semibold text-xl' id='goal-setting-and-transitions'>Goal setting and transitions</p>
                    <p>As students approach middle school and secondary education, it's crucial for them to consider their educational pathways.</p>
              ...
              {isInDepthVisible && (
              <>
                <p className='font-semibold text-xl' id='supporting-program extensions-and-differentiation-1'>Supporting program extensions and differentiation</p>
                  <p>Accommodations for learners engaged in ISELP provide the opportunity to explore concepts/assignments/tasks in greater depth and breadth. As such, the role of the ISSP teacher may be to advocate for this accommodation to &lsquo;open&rsquo; tasks and learning opportunities as opposed to assigning the learner additional work. To adequately support program extensions or differentiation, it is imperative that the ISSP teacher emphasize with classroom teachers that:</p>
                  <ol className='list-decimal pl-12 space-y-1'>
                    <li>Extensive/Alternative work should <b>not</b> be in addition to the standard work.</li>
                    <li>Evaluation of work produced in this manner should be assessed based on the standard, grade-level appropriate curricular expectations.</li>
                  </ol>
                  <p>Providing learners engaged in ISELP with additional work and grading &lsquo;harder&rsquo; on an alternative set of expectations is punitive (e.g., extra-workload, stricter expectations in terms of grades) and it is likely that the student will build a reluctance to attempt such work. Instead, ideas for enhancement could include allowing a multimedia presentation of work originally assigned as an essay, having the student study an area of interest in depth while classmates are learning a general overview of a subject, have the the student create a learning game to try with other students or other work that is derived from the student’s learner portrait and IEP goals.</p>
                  <p>Facilitating conversations with classroom teachers on programming can be one of the more delicate matters that an ISSP teacher will deal with in order to support a student who is engaged in ISELP. The ISSP teacher’s ultimate goal will be to act as an advocate for the learner’s needs while working with the student to develop their ability to self-advocate with classroom teachers. If successful, their experience as a student can be greatly empowered.</p>
                  ...
                  <ol className='list-disc pl-12 space-y-1'>
                    ...
                    <li><a href="https://www.ascd.org/el/articles/six-strategies-for-challenging-gifted-learners" target='_blank' className='text-[#0066CC] underline'>Six Strategies for Challenging Gifted Learners</a></li>
                    <li><a href="https://open.alberta.ca/dataset/ab22ff64-3358-4387-9761-8c58878a6b84/resource/8610bbbc-094a-4328-83e4-cabc579b5107/download/ipp92.pdf" target='_blank' className='text-[#0066CC] underline'>Planning for Students Who Are Gifted - Alberta Ministry of Education</a></li>
                  </ol>
                  ...
                  <p className='font-semibold text-xl' id='withdrawal-supports-(as needed)'>Withdrawal supports (as needed)</p>
                    ...
                    <ol className='list-disc pl-12 space-y-1'>
                      <li><i>Seminars/special projects</i> - Projects may include interdisciplinary studies or projects focused on the individual/group interests of the students involved.</li>
                      <li><i>Cluster grouping</i> - Students work in small groups on tasks or skills tailored to their Gifted Plan/Enhanced Learning Plan alternative goals and expectations.</li>
                      <li><i>Mentorships</i> - Students work with a student in a younger grade or a same-grade peer, serving as a mentor to that student, focused on areas of shared interest. Alternatively, the student works with a resource teacher, parent volunteer, or community expert to develop skills in a specific field. Mentoring relationships are a natural and supportive opportunity for both the mentor and mentee to enhance the student’s social-emotional learning skills.</li>
                      <li><i>Online collaboration</i> - Students can access virtual learning environments set up to connect students in a family of schools, providing remote opportunities to collaborate, connect with peers who share similar interests, or network with like-minded peers.</li>
                      <li><i>Leadership in areas of interest</i> - Facilitating/creating clubs, school ambassador, academic/extracurricular contests, community involvement (e.g., contributing to a local retirement home/legion/community centre, etc.)</li>
                    </ol>
                    <p>Most importantly, the work that students complete as part of a withdrawal opportunity should not be in addition to the work assigned as part of their regular classroom learning. These opportunities should be complementary to the regular work, and offered as an alternative task to what is assigned in the classroom during their withdrawal time.</p>
                    <p>When a student is provided with opportunities for withdrawal as part of their ISELP programming, staff should ensure that the work completed as part of this withdrawal is focused and tailored toward the alternative goals and expectations, as outlined in the student’s IEP.</p>
                 
                  <p className='font-semibold text-xl' id='opportunities-for-acceleration'>Opportunities for acceleration</p>
                    <p>Acceleration, which means to work through curricular topics at a greater pace than is usually expected, is another strategy to accommodate for the learning needs of Gifted students.</p>
                    <p>Teachers working with students engaged in ISELP can recommend variations of acceleration through asynchronous learning opportunities. The examples below provide suggestions for ways that ISELP students can explore accelerated learning opportunities while simultaneously working through the standard curricular work:</p>
                    <ol className='list-disc pl-12 space-y-1'>
                      <li>Preparing for science, computing, arts, business, and other subject-based contests (an extensive list of contests available to students can be found here: <a href="https://www.youthofcanada.ca/contests" target='_blank' className='text-[#0066CC] underline'>https://www.youthofcanada.ca/contests</a></li>
                      <li>Preparing for advanced mathematics-based contests (<a href = "https://cms.math.ca/competitions/canadian-mathematical-gray-jay-competition-cmgc/" target='_blank' className='text-[#0066CC] underline'>Canadian Mathematical Gray Jay Competition</a>, <a href = "https://www2.cms.math.ca/Competitions/COMC/2021/#main" target='_blank' className='text-[#0066CC] underline'>Canadian Open Mathematics Challenge</a>, <a href = "https://mathkangaroo.ca/" target='_blank' className='text-[#0066CC] underline'>Canadian Math Kangaroo Contest</a>, <a href = "https://cariboutests.com/" target='_blank' className='text-[#0066CC] underline'>Caribou Mathematics Competition</a>, <a href = "https://mathkangaroo.ca/" target='_blank' className='text-[#0066CC] underline'>Canadian Math Kangaroo Contest</a>, <a href = "https://www.cemc.uwaterloo.ca/contests/gauss.html" target='_blank' className='text-[#0066CC] underline'>Gauss Mathematics Contests</a>)</li>
                    </ol>
                    <p>The link below discusses the benefits of acceleration for Gifted learners: </p>
                    <p><a href = "https://nagc.org/page/acceleration" target='_blank' className='text-[#0066CC] underline'>Acceleration | National Association for Gifted Children</a></p>
                  
                  <p className='font-semibold text-xl' id='mental-health-(asynchronous-development)'>Mental Health (Asynchronous Development)</p>
                    <p>Gifted learners will frequently develop in an asynchronous manner. For example, cognitively they can be quite mature relative to their peer group (e.g. greater ability for abstract reasoning, eloquent use of language, etc.) but socially can be immature and unsure as to how to relate to their peers. This can lead to anxieties and feelings of not belonging. It is important for the ISSP and/or Guidance teacher to keep apprised of their feelings in this regard.</p>
                    <p>As with any child, a Gifted learner may not immediately open up to the support teachers about such issues. A good starting point for discussions will lean more toward their academic needs. If the learner senses that the ISSP/Guidance teacher is an effective support for them, they may begin to relay their perceptions and thus allow you to work with them in closing such gaps.</p>
                    ...
                    <p>As with any student requiring the support of PSSP staff, Gifted students can be brough to a Student Review Meeting to discuss interventions and supports that can be provided by board PSSP staff (e.g., Psychologists, Social Workers). Below is an outline of the services available from PSSP staff:</p>
                      ...
                      <p className = "font-semibold text-base">Social Work</p>
                        ...
                        <ol className='list-disc pl-12 space-y-1'>
                          ...
                          <li>consultations with school personnel including SRM Level 2</li>
                          <li>crisis intervention</li>
                          <li>facilitation of referrals to community agencies/resources</li>
                        </ol>
                      ...
                      <p className = "font-semibold text-base">Psychology Consultants</p>
                        <p>Psychoeducational Consultants provide a variety of psychological services to schools. Currently, the most frequently requested types of service from the Psychology Department are:</p>
                        <ol className='list-disc pl-12 space-y-1'>
                          <li>psychoeducational assessment</li>
                          <li>consultation, including behavioural</li>
                          <li>support pertaining to SEA documentation</li>
                          <li>counselling individual students/parents on a short-term basis</li>
                          <li>providing PD for schools, teachers, BEAs and parent groups</li>
                ...
                <p className='font-semibold text-xl' id='building-self-advocacy-skills'>Building Self-Advocacy Skills</p>
                  ...
                  <ol className = 'list-disc pl-12 space-y-1'>
                    ...
                    <li>Identify the issue/problem while recognizing others’ perspectives</li>
                  ...
                  <ol className = 'list-disc pl-12 space-y-1'>
                      ...
                      <li><a href = "https://www.washingtonpost.com/archive/lifestyle/wellness/1986/09/02/the-eight-great-gripes-of-gifted-children/846771c4-6943-4633-9cb6-14940a13f508/" target='_blank' className='text-[#0066CC] underline'>8 Great Gripes of Gifted Children</a></li>
                      <li><a href = "https://blog.freespiritpublishing.com/" target='_blank' className='text-[#0066CC] underline'>Empower Gifted Learners to Advocate for Themselves</a></li>
                      <li><a href = "https://gifted.education.uconn.edu/wp-content/uploads/sites/612/2014/08/Scales-for-Rating-the-Behvioral-Characteristics-of-Superior-Students.pdf" target='_blank' className='text-[#0066CC] underline'>Renzulli Scales for Rating the Behavioral Characteristics of Superior Students</a></li>
                      <li><a href = "https://www.amazon.com/gp/product/1593633483/ref=as_li_qf_asin_il_tl?ie=UTF8&tag=deborahreber-20&creative=9325&linkCode=as2&creativeASIN=1593633483&linkId=ddadce56f61e460258c586448559847c" target='_blank' className='text-[#0066CC] underline'>Programs and Services for Gifted Secondary Students: A Guide to Recommended Practices</a></li>
                      <li><a href = "https://www.teachercreatedmaterials.com/free-spirit-publishing/audience/educator/" target='_blank' className='text-[#0066CC] underline'>The Power of Self-Advocacy for Gifted Learners: Teaching the 4 Essential Steps for Success</a></li>
                  </ol>
                ...
                <p className='font-semibold text-xl' id='SRMs-and-case-conferences'>SRMs and Case Conferences</p>
