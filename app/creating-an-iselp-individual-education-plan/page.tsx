    ...
    <>
      ...
      <div className='flex flex-row w-11/12 mx-auto my-6 lg:mt-8 lg:mb-16 max-w-6xl lg:space-x-16 overflow-visible text-wrap'>
        <div className='min-w-56 text-nowrap truncate space-y-2 sticky top-8 h-full *:truncate text-sm hidden lg:block'>
          ...
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#adjustments-to-the-learning-as-part-of-an-ISELP-IEP" className='ml-2'>Adjustments to the learning as part of an ISELP IEP</CustomLinkA></p>
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#differentiation-and-program-development" className='ml-2'>Differentiation and program development</CustomLinkA></p>
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#developing-a-comprehensive-understanding-of-the-student-engaged-in-ISELP" className='ml-2'>Developing a comprehensive understanding of the student engaged in ISELP</CustomLinkA></p>
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#the-collaborative-consultation-approach" className='ml-2'>The collaborative consultation approach</CustomLinkA></p>
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#accomodations-as-part-of-the-ISELP-IEP-1" className='ml-2'>Accommodations as part of the ISELP IEP</CustomLinkA></p>
          <p onClick={() => setIsInDepthVisible(true)}><CustomLinkA href="#alternative-skills-pages" className='ml-2'>Alternative skills pages</CustomLinkA></p>
        ...
        <div className='flex flex-col mx-auto max-w-[92vw]'>
          ...
          <p className='font-semibold'>Tailoring the IEP to the student portrait</p>
            ...
            <hr />
              ...
              <p className="font-semibold" id='areas-of-an-IEP-that-are-applicable-to-learners-engaged-in-ISELP'>Areas of an IEP that are applicable to learners engaged in ISELP</p>
                ...
                <p className="font-semibold" id='accomodations-as-part-of-an-ISELP-IEP'>Accommodations as part of an ISELP IEP</p>
            ...
            {isInDepthVisible && (
              <>
                <p className="font-semibold text-xl" id='adjustments-to-the-learning-as-part-of-an-ISELP-IEP'>Adjustments to the learning as part of an ISELP IEP</p>
                  ...
                  /> 
                  <p className='text-xs text-slate-500'>Figure 1 - Adapted from <a href="https://www.abcontario.ca/images/pdfs/iep_guide_rev_april_20.pdf" target='_blank' className='text-[#0066CC] underline'>https://www.abcontario.ca/images/pdfs/iep_guide_rev_april_20.pdf</a>, p. 15</p>
                ...
                <p className="font-semibold text-xl" id='the-collaborative-consultation-approach'>The collaborative consultation approach</p>
                    ...
                    <table className="w-full text-sm text-left text-gray-700 min-w-[800px]">
                      ...
                      <tbody>
                        <tr className="bg-white border-b border-gray-200">
                          <td className="py-4 px-6">Share information and observations about the student&rsquo;s behaviour and learning in a variety of settings</td>
                        ...
                        <tr className="bg-gray-50 border-b border-gray-200">
                          <td className="py-4 px-6">Develop a common understanding of the student&rsquo;s strengths and needs as they affect the student&rsquo;s ability to learn and demonstrate learning, and the student&rsquo;s educational goals</td>
                          <td className="py-4 px-6">
                            <ol className='list-disc space-y-2'>
                        ...
                        <tr className="bg-white border-b border-gray-200">
                          <td className="py-4 px-6">Discuss possible accommodations that can help the student learn and demonstrate learning</td>
                          <td className="py-4 px-6">
                            <ol className='list-disc space-y-2'>
                        ...
                        <tr className="bg-gray-50 border-b border-gray-200">
                          <td className="py-4 px-6">Discuss the type and level of support required from support services personnel</td>
                          <td className="py-4 px-6">
                            <ol className='list-disc space-y-2'>
                  ...
                  <p className='text-xs text-slate-500'>* adapted from <a href='https://files.ontario.ca/edu-special-education-policy-resource-guide-en-2022-05-30.pdf' target='_blank' className='text-[#0066CC] underline'>Special Education in Ontario, 2017</a></p>
                    ...
                    <ol className='list-decimal pl-12'>
                      <li><p className='pb-2'>Performance Goals:</p>
                        <ol className='list-disc pl-12 space-y-1'>
                          <li>What Students Focus On: Students with performance goals care a lot about their grades and proving their abilities. They are focused on academic performance.</li>
                          <li>How They Approach Learning: They focus on real-world application and problem-solving. Mastery-focused learning emphasizes developing healthy learning habits, such as asking questions and seeking support when needed.</li>
                          <li>Impact: This approach reduces anxiety because they seek help and understand their mistakes.</li>
                        </ol>
                      </li>
                      <li><p className='pb-2 pt-4'>Mastery Goals:</p>
                        <ol className='list-disc pl-12 space-y-1'>
                          <li>What Students Focus On: Students with mastery goals are more interested in learning and improving their skills. They are more willing to investigate mistakes and understand their errors.</li>
                          <li>How They Approach Learning: They focus on real-world application and problem-solving. Mastery-focused learning emphasizes developing healthy learning habits, such as asking questions and seeking support when needed.</li>
                          <li>Impact: This approach reduces anxiety because they seek help and understand their mistakes.</li>
                        </ol>
                      </li>
            ...
            {isFurtherReadingVisible && (
              <>
                  <p><a href="https://files.ontario.ca/edu-special-education-policy-resource-guide-en-2022-05-30.pdf" target='_blank' className='text-[#0066CC] underline'>Special Education in Ontario - Kindergarten to Grade 12: Policy and Resource Guide</a></p>
                  <p><a href='https://pdsb1.sharepoint.com/TL/SpecialEd/Sec/Shared%20Documents/IEP/Spec%20Ed%20Categories%20and%20Accommodations.pdf' target='_blank' className='text-[#0066CC] underline'>Ontario Special Education Companion</a></p>
                  <p><a href='https://www.abcontario.ca/images/pdfs/iep_guide_rev_april_20.pdf ' target='_blank' className='text-[#0066CC] underline'>Developing Individual Education Plans for Gifted Students: Information for Parents and Guardians (from ABC Ontario)</a></p>
                  <p><a href='https://www.abcontario.ca/resources-support/understanding-giftedness/schooling ' target='_blank' className='text-[#0066CC] underline'>ABC Ontario - &lsquo;Talking With Educators&rsquo; (helpful descriptions of what programming should be included in a Gifted student&rsquo;s education plan)</a></p>
                  <p><a href='https://people.wou.edu/~girodm/100/mastery_vs_performance_goals.pdf' target='_blank' className='text-[#0066CC] underline'>Learning goal orientation - Mastery vs. Performance Goals</a></p>
                  <p><a href='https://plato.stanford.edu/entries/critical-thinking/ ' target='_blank' className='text-[#0066CC] underline'>Critical thinking skills</a></p>
                  <p><a href='https://positivepsychology.com/self-regulation/' target='_blank' className='text-[#0066CC] underline'>Self Regulation Theory</a></p>
              </>
            )}
          </div>
        </div>
